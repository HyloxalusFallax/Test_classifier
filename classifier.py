...
#save model
model.save_weights('./models/classifier_both.h5')

#save history
pd.DataFrame.from_dict(history.history).to_csv('classifier_history_both.csv', index=False)

#test after model is trained
model.load_weights('./models/classifier_both.h5')
